#' Fast Truncated Normal Distribution
#'
#' \pkg{tnorm} package implements \code{dtnorm} and \code{rtnorm} functions,
#' using an algorithm described in Robert (1995). The source codes are based on
#' Jonathan Olmsted's RcppTN 0.1-8 and Christopher Jackson's msm 1.5.
#'
#' @name tnorm-package
#' @aliases tnorm
#' @docType package
#' @author  Yi-Shin Lin <yishin.lin@utas.edu.au>
#' @references Robert, C. (1995). \emph{Simulation of truncated normal variables},
#' \emph{Statistics and Computing} \bold{5}, 121--125. \cr
#' Olmsted, J. \url{https://github.com/olmjo/RcppTN}.
#' @keywords package
